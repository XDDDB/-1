...
var addOrder_management=function(req,res){
    ...
    var data=[body.account,body.id,body.quantity,time,body.status,order_id,body.consignee,body.region,body.detailed_address,body.phone,body.tel,body.leave_word,body.freight]
    console.log(data)
    var sql='INSERT INTO order_management(account,id,quantity,time,status,order_id,consignee,region,detailed_address,phone,tel,leave_word,freight) values(?)'
    //操作数据库
