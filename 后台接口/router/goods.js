...
var editGoods=function(req,res){
    ...
    var body=req.body
    var files=req.files
    var goodsImg1=body.originImg
    var attr1=body.originImg1
    console.log(1111111111111)
    console.log(files.goodsImg)
    ...
    //操作数据库
    // var data=[[body.name,body.price,body.brand,body.type,body.derive,body.date,body.prototype,body.category,body.ratio,body.age,goodsImg1,Number(body.limitation),attr1,Number(body.status),getTime(body.createTime)],body.id]
