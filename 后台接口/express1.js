...
//新增信息单
app.post('/addInformation_sheet',router.addInformation)

//信息详情
app.post('/getDetailInformation',router.getDetailInformation)

//新增订单
app.post('/addOrder_management',router.addOrder_management)

//获取订单
app.post('/getOrder_management',router.getOrder_management)

//删除订单
app.post('/deletaOrder_management',router.deletaOrder_management)
